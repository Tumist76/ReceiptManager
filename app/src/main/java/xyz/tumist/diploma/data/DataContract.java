...
public class DataContract {
    ...
    public static abstract class GoodEntry implements BaseColumns {
        ...
        public static final String COLUMN_GOOD_ID = "_id";
        public static final String COLUMN_GOOD_MODIFIERS = "good_modifiers";
        public static final String COLUMN_GOOD_NAME = "good_name";
        public static final String COLUMN_GOOD_NDS0 = "good_nds0";
    ...
    public static abstract class PurchaseEntry implements BaseColumns{
        ...
        public static final String COLUMN_PURCHASE_DISCOUNTSUM = "purchase_discount_sum";
        public static final String COLUMN_PURCHASE_ECASHTOTALSUM = "purchase_ecashTotalSum";
        public static final String COLUMN_PURCHASE_TOTALSUM = "purchase_totalSum";
        ...
        public static final String COLUMN_PURCHASE_KKTNUMBER = "purchase_kktNumber";
        ...
        public static final String COLUMN_PURCHASE_STORE_ID_FK = "store_id_FK";
